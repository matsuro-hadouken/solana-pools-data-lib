...
mod tests {
    ...
    fn test_error_empty_pool_name() {
        ...
        assert!(
            matches!(
                result,
                Err(crate::error::PoolsDataError::ConfigurationError { .. })
            ),
            "Expected ConfigurationError for empty pool name"
        );
    }
    ...
    fn test_error_empty_authority() {
        ...
        assert!(
            ...
            "Expected ConfigurationError for empty authority"
        );
    }
    ...
    fn test_active_account_statistics() {
        use crate::types::{
            ProductionStakeAccountInfo, ProductionStakeAuthority, ProductionStakeDelegation,
